        ...
        <table class="object_table">
            ...
            <?php foreach ($afficherMaisons as $element) { ?>
                ...
                <tr> 
                    ...
                    echo '<td><a href="index.php?cible=datePropriete&fonction=modifier&id='.$element['Id_Maison'].'&datefin='.$element['dateFinPropriete'].'&datedebut='.$element['dateDebutPropriete'].'">Modifier la date de fin de propriété</a></td>';
                    ?>
                </tr>
