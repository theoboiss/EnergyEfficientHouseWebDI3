        ...
        <table class='object_table'>
            ...
            <?php foreach ($afficherAppartements as $element) { ?>
                ...
                <tr> 
                    ...
                    echo '<td><a href="index.php?cible=dateLocation&fonction=modifier&id='.$element['Id_Appartement'].'&datedebut='.$element['dateDebutLocation'].'&datefin='.$element['dateFinLocation'].'">Modifier la date de fin de location</a></td>';
                    ?>
                </tr>
